...
def main():
    ...
    with st.sidebar:
        ...
        st.write("- [Hariom Ingle](https://github.com/Hariom-Ingle)") 
        st.write("- [Chetan Rathod](https://github.com/ChetanRRathod)")  
    ...
    with st.spinner("Scanning the database..."):
        ...
        st.success("Database scanned and configured Successfully!")
